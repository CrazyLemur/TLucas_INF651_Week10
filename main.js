...
button1.addEventListener("click", (event) => {document.getElementById("p1").textContent = "Hello World! I'm listening to events."});
...
const button2Toggle = () => {
    ...
    if (p2.textContent === "This button toggles text content.") {
        p2.textContent = "Paragraph Two."
    }
    else p2.textContent = "This button toggles text content."
}

const button2 = document.getElementById("button2");
button2.addEventListener("click", button2Toggle);
...
button3.addEventListener("click", (event) => {document.getElementById("p3").textContent = "Third button clicked."});
...
button4.addEventListener("click", (event) => {document.getElementById("p4").classList.add("fourthPara")});
...
button5.addEventListener("click", (event) => {document.getElementById("p5").classList.toggle("fourthPara")});
